...
$sql= "SELECT * FROM hoadon, phieudangki,lophoc,capdo WHERE hoadon.map=phieudangki.map AND phieudangki.mal=lophoc.mal AND lophoc.macd=capdo.macd AND hoadon.map='$_GET[map]'";
...
?>
    ...
    justify-content: space-between;">
            ...
            <h3 style="margin-top: 19px;font-size:23px;" >HOÁ ĐƠN ĐÓNG HỌC PHÍ </h3>
			<p style="margin-top:14px; margin-bottom:0;font-size: 14px;">Mã hóa đơn: <?php echo $row['mahd']?>   </p>
			</div>
        ...
        <div class="thongtincoban" >
			...
			<ul style="list-style:none;width:75%;padding-left:0; color: black;" >
				<!-- <li><?php echo $row['mahd']?></li> -->
				<li><?php echo $row['tenph']?></li>
				<li style="display:flex;justify-content: space-between;"><?php echo $user['tenhv']?> <p style="margin-bottom:0;color:#777;margin-left: 4px;">Địa chỉ:</p><?php echo $user['diachihv']?></li>
				<!-- <li></li> -->
