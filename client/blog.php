...
$sql_tt = "SELECT * FROM tintuc, loaitt WHERE tintuc.maltt = loaitt.maltt AND loaitt.maltt = '$_GET[ma]' ORDER BY matt ASC LIMIT $begin,3" ;
...
?>
    ...
    <div class="container-fluid bg-primary mb-5">
      ...
      >
        <h3 class="display-3 font-weight-bold text-white"><?php echo $row_title['tenltt']; ?></h3>
        <div class="d-inline-flex text-white">
          <p class="m-0"><a class="text-white" href="index.php">Trang chủ</a></p>
          <p class="m-0 px-2">/</p>
          <p class="m-0"><?php echo $row_title['tenltt']; ?></p>
        </div>
      </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid pt-5">
      <div class="container">
        <div class="text-center pb-2">
          ...
          <h1 class="mb-4">Bài viết mới nhất từ <?php echo $row_title['tenltt']; ?></h1>
        </div>
        ...
        <?php
          ...
          <?php
                    $sql_trang = mysqli_query($mysqli,"SELECT * FROM tintuc, loaitt WHERE tintuc.maltt = loaitt.maltt AND loaitt.maltt = '$_GET[ma]'");
            ...
            <?php if(!empty($trang) && $trang>1){ ?>
              ...
              <?php if($page>1):$prev_page = ($page-1);?>
                <li class="page-item disabled">
                  <a class="page-link" href="index.php?page=blog&ma=<?php echo $row_title['maltt'] ?>&trang=<?php echo $prev_page ?>" aria-label="Previous">
                ...
                <li class="page-item <?php echo ($i==$page)?'active':FALSE; ?>">
                  <a class="page-link" href="index.php?page=blog&ma=<?php echo $row_title['maltt'] ?>&trang=<?php echo $i ?>"><?php echo $i ?></a>
                </li>
                <?php
                  }
                ?>
                ...
                <li class="page-item">
                  <a class="page-link" href="index.php?page=blog&ma=<?php echo $row_title['maltt'] ?>&trang=<?php echo $next_page ?>" aria-label="Next">
