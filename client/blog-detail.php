...
<?php
if (isset($_GET['blog'])) {
  $query = "SELECT * FROM tintuc, loaitt WHERE tintuc.maltt = loaitt.maltt AND tintuc.matt= '$_GET[blog]'";
  ...
  ?>
    ...
    <div class="container-fluid bg-primary mb-5">
      <div
        ...
        <h3 class="display-3 font-weight-bold text-white"><?php echo $row['tenltt']; ?></h3>
    ...
    <div class="container py-5">
      <div class="row pt-5">
        <div class="col-lg-8">
          <div class="d-flex flex-column text-left mb-3">
            <p class="section-title pr-5">
              <span class="pr-2"><?php echo $row['tenltt'] ?></span>
            </p>
            <h1 class="mb-3"><?php echo $row['tentt'] ?></h1>
            <div class="d-flex">
              
              <b class="mr-3" style="display: flex;"
                    ><i class="fa fa-calendar  text-primary" style=" padding-top: 2px;"></i><p class="tintuc__ngay" style="margin: 0  0 0 5px;">  <?php echo $row['ngaytt'] ?></p></b
                  >
            </div>
          </div>
          <div class="mb-5">
            ...
            <img
              ...
              src="../admin/uploads/<?php echo $row['anhtt'] ?>"
              alt="Image"
            />
            
            <p>
            <?php echo nl2br($row['noidungtt']) ?>
            </p>
        ...
        <div class="col-lg-4 mt-5 mt-lg-0">
          ...
          <!-- Search Form -->
          <div class="mb-5">
            <form action="index.php?page=search-blog" method="post" >
          ...
          <div class="mb-5">
            ...
            <?php
              ...
              >
                <a href="index.php?page=blog&ma=<?php echo $row_loaitt['maltt'];?>"><?php echo $row_loaitt['tenltt']?></a>
                <?php
                    // $sql = mysqli_query($mysqli,"SELECT *FROM tintuc, loaitt WHERE tintuc.maltt=loaitt.maltt AND tintuc.matt = '$_GET[ma]'");
                    // $count = mysqli_num_rows($sql);
                ?>
                <?php 
                  $sql_l = "SELECT * FROM tintuc, loaitt WHERE tintuc.maltt = loaitt.maltt AND loaitt.maltt= '$row_loaitt[maltt]'" ;
          ...
          <!-- Recent Post -->
          <?php
            $sql_tint = "SELECT * FROM tintuc, loaitt WHERE tintuc.maltt = loaitt.maltt ORDER BY matt DESC LIMIT 3" ;
          ...
          <div class="mb-5">
            ...
            >
              <img
                class="img-fluid"
                src="../admin/uploads/<?php echo $row_tint['anhtt'] ?>"
                style="width: 100px; height: 80px"
              />
              <div class="pl-3">
                <a href="index.php?page=blog-detail&blog=<?php echo $row_tint['matt'] ?>" style="display:contents"><h6 class=""><?php echo $row_tint['tentt'] ?></h6>
                <div class="d-flex">
                  <small class="mr-3" style="display:flex;"
                    ><i class="fa fa-calendar text-primary" ></i> <p class="tintuc__ngay" style="margin: 0  0 0 5px;padding-bottom: 2px;"><?php echo $row_tint['ngaytt'] ?></p></small
                  >
                </div>
              </div>
            </div>
          ...
          <div class="mb-5">
            ...
            <?php
                  ...
                  while ($row_loaitt = mysqli_fetch_array($query_loaitt)) {
                  ?>
              <a class="btn btn-outline-primary m-1" href="index.php?page=blog&ma=<?php echo $row_loaitt['maltt'];?>"><?php echo $row_loaitt['tenltt']?></a>
              <?php } ?>
