...
<?php
	...
	if(isset($_POST['doimatkhau'])){
	 ...
	 if($_POST['repass']!=$_POST['newpass']){
		...
		$sql ="UPDATE hocvien SET password ='$password' WHERE email='".$_SESSION['mail']."'";
    ...
    <form class="form" action="" method="POST">
                ...
                <div class="register--content">
					...
					<div style="border-radius: 3px;
								...
								display: block;
							">                    
						<p style="color: #01394f;padding: 19px 16px 0px;font-size: 14px;margin: 0px;">Đổi mật khẩu mới tại đây</p>
					</div>
					<?php } ?>
                    <div class="email">
					...
					<div class="email">
                        <input type="password" id="repass" name="repass" placeholder="Xác nhận mật khẩu" class="inputText"/>
