...
<div class="container-fluid bg-primary mb-5">
      ...
      >
        <h3 class="display-3 font-weight-bold text-white">Lịch học</h3>
        <div class="d-inline-flex text-white">
          <p class="m-0"><a class="text-white" href="index.php">Trang chủ</a></p>
          <p class="m-0 px-2">/</p>
          <p class="m-0">Lịch học</p>
        </div>
      </div>
</div>
<?php
                ...
                <div class="table-res" style="width: 70%;">
                  <table class="table-his" style="width: 100%;;
                    ...
                    <thead style=" text-align: justify;height: 50px;color: white;">
                      <tr>
                        <th style="padding-left: 10px;">Thứ</th>
                        <!-- <th>Tên học viên</th>  -->
                        <th>Lớp</th>
                        <th>Kĩ năng</th>
                        <th>Giáo viên</th>
                    ...
                    <tbody>
                        <?php
                      $sqllop="SELECT * FROM phieudangki, lophoc, hocvien WHERE phieudangki.mal=lophoc.mal AND phieudangki.mahv='$_GET[mahv]'";
                      $querylop = mysqli_query($mysqli, $sqllop);
                      $rowlop = mysqli_fetch_array($querylop);

                      $sql_lh= "SELECT * FROM lichhoc, lophoc, thu, kynang, giaovien WHERE lichhoc.mal=lophoc.mal AND lichhoc.mat=thu.mat AND lichhoc.makn=kynang.makn AND lichhoc.magv=giaovien.magv AND lichhoc.mal= '$rowlop[mal]' ORDER BY malh ASC";
                      ...
                      <tr style="height: 77px; background-color: #ebfcff;">
                        <td style="padding-left: 10px;"> <strong><?php echo $row['tent'] ?></strong></td>
