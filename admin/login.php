...
?>
  ...
  <body>
    ...
    margin-bottom: 20px;">
              ...
              <!-- /Logo -->
              <!-- <h4 class="mb-2">Chào mừng đến Deluxe hotel! 👋</h4>
              <p class="mb-4">Đăng nhập tài khoản của bạn để sử dụng dịch vụ của chúng tôi</p> -->
              ...
              <form id="formAuthentication" class="mb-3" action="" method="POST">
                <div class="mb-3">
                  ...
                  <input
                    ...
                    id="username"
                    name="username"
                    placeholder="Nhập vào username của bạn"
                    autofocus
                  />
                </div>
