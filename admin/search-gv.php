                  ...
                  <table class="table">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $rowtk['tengv'] ?></td>
                        <td><?php echo $rowtk['sdtgv']?></td>
                        <td><?php echo $rowtk['diachigv']?></td>
                        <td><?php echo $rowtk['kinhnghiemgv']?></td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" onclick="" href="?action=quanlygiaovien&query=edit&madv=<?php echo $rowtk['magv'] ?>"
                                ><i class="bx bx-edit-alt me-1"></i> Sửa</a
                              >
                              <a class="dropdown-item" onclick="return Del('<?php echo $rowtk['tengv'] ?>')" href="list_giaovien.php?magv=<?php echo $rowtk['magv'] ?>"
