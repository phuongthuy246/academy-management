...
if (isset($_POST['themcd'])) {
	$sql_them = "INSERT INTO capdo(tencd,dotuoi, motacd,noidung, muchocphi, anhcd) VALUE ('" . $tencd . "','" . $dotuoi . "','" . $motacd . "','" . $noidung . "','" . $muchocphi . "','" . $anhcd . "')";
...
<div class="container-xxl flex-grow-1 container-p-y">
              <div class="th" style="display: flex; justify-content: space-between;">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Danh mục /</span> Cấp độ</h4>
              ...
              <div class="navbar-nav align-items-start" style="
                            ...
                            padding-left: 20px;
                        ">
                <form action="index.php?action=capdo&query=timkiem"  method="post" class="nav-item d-flex align-items-center">
              ...
              <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    $i = 0;
                    while ($row = mysqli_fetch_array($query_lietke_capdo )) {
                      $i++;
                    ?>
                      <tr>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    ...
                                    <input type="text" id="nameBasic" name="dotuoi" class="form-control" placeholder="" />
                                  </div>
                                </div>
